    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center">
                <div class="sidebar-brand-text mx-3">Lecturer Page</div>
            </a>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item active">
                <a class="nav-link" href="mainDosen.php">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-10">
                                    <h6 class="m-0 font-weight-bold text-primary text-lg mb-1">Welcome <?php echo $username?> !</h6>
                                    <h6 class="text-xs">Anda telah login sebagai <?php echo $level?></h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <a class="card-body" href="matkulDosen.php">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <a class="card-body" href="up-down/index.php">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                        <div class="font-weight-bold text-info text-uppercase  mb-1">Materi</div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
