            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tugas Pemrograman Web</h1>
                        <br>
                    </div>
                    ...
                    ?>       
                        ...
                        <div class="card-body">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <?php 
                                $nilai = mysqli_fetch_assoc(mysqli_query($conn,"SELECT nilai FROM tugas WHERE username = '$username'"));
                                ?>
                                <tr>
                                    <td>Status</td>
                                    <td>: <?php 
                                ...
                                <p>
                                <?php 
                                $id_penugasan = mysqli_fetch_assoc(mysqli_query($conn,"SELECT * FROM penugasan, tugas WHERE penugasan.id_penugasan = tugas.id_penugasan"));
                                ?>
                                <form action="uploadTugas.php" method="POST" enctype="multipart/form-data">
                                    <td>Select file to upload</td>
                                    <td>:  <input type="file" name="file" type="file">
                                    <input type="submit" value="Upload" name="upload">
                                    <input type="hidden" name="id_penugasan" value="<?php echo $id_penugasan['id_penugasan']?>">
                                    </td>
                                </form>
                                </p>
                                </tr>
